...
In order to install DSF packages using Maven you need a personal GitHub access token. This [GitHub documentation](https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/creating-a-personal-access-token) shows you how to generate one.
...
The following entry is required in the `hosts` file of your computer so that the FHIR servers of the simulated organizations can be accessed in your web browser. On Linux and Mac this file is located under the path `/etc/hosts`. On Windows you can access it in `C:\Windows\System32\drivers\etc\hosts`.
